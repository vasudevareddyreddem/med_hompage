        ...
        <section class="wow fadeIn pt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <a href="hospital-management-software.php" class="btn btn-primary btn-md navbar-color darken-3">View more</a>
        ...
        <section class="wow fadeIn pt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <a href="healthcards.php" class="btn btn-primary btn-md navbar-color darken-3">View more</a>
        ...
        <section class="mt-5 wow fadeIn" id="waste-m-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <!-- Main heading -->
                    <a href="waste-management-system.php" class="btn btn-primary btn-md navbar-color">View more</a>
